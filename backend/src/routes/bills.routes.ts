...
import { billPaymentSchema, billQuerySchema, createBillSchema, updateBillSchema } from "../schemas/bill.schema.js";
...
billsRouter.patch("/:id/pay", writeRateLimit, validateRequest({ params: idParamSchema, body: billPaymentSchema }), asyncHandler(controller.pay));
