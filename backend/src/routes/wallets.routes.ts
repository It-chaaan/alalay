...
import { createWalletSchema, createWalletWithOpeningBalanceSchema, creditRepaymentSchema, updateWalletSchema, walletDepositSchema, walletInterestSchema, walletTransferSchema } from "../schemas/wallet.schema.js";
...
walletsRouter.post("/:id/repayments", writeRateLimit, validateRequest({ params: idParamSchema, body: creditRepaymentSchema }), asyncHandler(controller.repayment));
