...
import { ArrowLeft, MoreHorizontal, Repeat } from 'lucide-react-native';
...
type Sub = { id: string; name: string; amount: number | string; renewal_date: string; billing_cycle: Frequency; auto_renew: boolean; logo_url?: string | null; wallet_id?: string | null };
