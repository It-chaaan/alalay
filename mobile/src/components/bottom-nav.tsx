...
export function BottomNav() {
  ...
  return <View style={[styles.bottomNav, { bottom: BOTTOM_NAV_BOTTOM_OFFSET + insets.bottom }]}>
    ...
    <Pressable accessibilityRole="button" accessibilityLabel="Open OCR scanner" onPress={() => router.replace('/(tabs)/ocr')} style={({ pressed }) => [styles.addButton, pressed && styles.pressed]}><Camera size={25} color="#FFFFFF" strokeWidth={2} /></Pressable>
...
const styles = StyleSheet.create({
  bottomNav: { position: 'absolute', left: 16, right: 16, height: BOTTOM_NAV_HEIGHT, paddingHorizontal: 9, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', borderRadius: 28, backgroundColor: palette.surface, borderWidth: 1, borderColor: palette.line, shadowColor: '#063224', shadowOpacity: 0.14, shadowRadius: 13, elevation: 7, zIndex: 50 },
