...
import { ChevronRight, MoreHorizontal as MoreHorizontalIcon, Plus, WalletCards, X as CloseIcon } from 'lucide-react-native';
...
type WalletTransaction = { id: string; kind: 'income' | 'expense' | 'bill' | 'deposit' | 'opening_balance'; label: string; date: string; amount: number };
...
export default function WalletsScreen() {
  ...
  const openWallet = async (wallet: Wallet) => { setDeleteError(''); await loadWalletDetail(wallet.id); };
  useEffect(() => {
